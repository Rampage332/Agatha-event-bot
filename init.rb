...
@agatha_bot.command(:rank) do |event|
  ...
  csv_table = CSV.table("349 Managerial Sheet - AgathaSheet.csv", converters: :all)
      ...
      if player_array.nil?
          ...
          event.respond "Submission Form: https://forms.gle/Wyi49Q6BMzKsw1QK6"
      ...
      if player_array[2] > 84
          ...
          img_url = "https://i.imgur.com/taqtJqO.png"
            ...
            event.channel.send_embed do |embed|
                    ...
                    embed.description = "__                                                                           __"
                    embed.add_field(name: '<:rank:947154489452920892> **Server Rank**', value: player_array[1], inline: true)
                    embed.add_field(name: "**Overall Score**", value: "#{player_array[2]}%", inline: true)
                    embed.add_field(name: '<:viler:947155044577448047> **Viler Score**', value: "#{player_array[3]}%", inline: true)
                    embed.add_field(name: "<:Runes:947154489121599519> **Runes Score**", value: "#{player_array[4]}%", inline: true)
                    embed.add_field(name: '<:equipment:947154489276792862> **Equipment Score**', value: "#{player_array[5]}%", inline: true)
